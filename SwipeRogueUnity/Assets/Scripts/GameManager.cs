...
//		Camera.main.transform.Translate (new Vector3 (horizontal, vertical, 0.0f));
		...
		if (Input.GetKey (KeyCode.Mouse0)) {
			...
			currentPosition += (inputDownPosition - Input.mousePosition) * 0.001f;
...
//			Vector3 moveTo = Vector3.MoveTowards (Camera.main.transform.position, floorScript.currentRoom.transform.position, Time.deltaTime);
